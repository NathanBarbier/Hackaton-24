...
const PredictionTopComponent = () => {
    const [data, setData] = useState(null);

    useEffect(() => {
        // axios.get('http://127.0.0.1:8080/api/predictionsTop')
        axios.get('https://hackaton-24.onrender.com/api/predictionsTop')
            .then(response => {
...
export default PredictionTopComponent;
